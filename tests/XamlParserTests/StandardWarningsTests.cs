...
>
    <StandardWarningsTestsClass.ObjectProperty><x:Static Member='StandardWarningsTestsClass.StaticProp'/></StandardWarningsTestsClass.ObjectProperty>
        ...
        Assert.Contains(obsoletes, d => d.Description == "StandardWarningsTestsClass is obsolete" && d is { XamlXCode: XamlXDiagnosticCode.Obsolete, Severity: XamlDiagnosticSeverity.Warning });
        Assert.Contains(obsoletes, d => d.Description == "ObjectProperty is obsolete" && d is { XamlXCode: XamlXDiagnosticCode.Obsolete, Severity: XamlDiagnosticSeverity.Warning });
        Assert.Contains(obsoletes, d => d.Description == "StaticProp is obsolete" && d is { XamlXCode: XamlXDiagnosticCode.Obsolete, Severity: XamlDiagnosticSeverity.Error });
    }
}