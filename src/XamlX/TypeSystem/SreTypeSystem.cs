...
namespace XamlX.TypeSystem
{
    ...
    class SreTypeSystem : IXamlXTypeSystem
    {
        ...
        class SreMethodBase : SreMemberInfo
        {
            ...
            protected IReadOnlyList<IXamlXType> _parameters;
        ...
        class SreTypeBuilder : SreType, IXamlXTypeBuilder
        {
            ...
            class SreMethodBuilder : SreMethod, IXamlXMethodBuilder
            {
                ...
                public SreMethodBuilder(SreTypeSystem system, MethodBuilder methodBuilder,
                    IReadOnlyList<IXamlXType> parameters) : base(system, methodBuilder)
                {
                ...
                bool isInterfaceImpl, IXamlXMethod overrideMethod)
            {
                ...
                var largs = (IReadOnlyList<IXamlXType>)(args?.ToList()) ?? Array.Empty<IXamlXType>();
