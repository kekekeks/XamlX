    ...
    public class XamlXContext
    {
            ...
            IXamlXType rootType)
        {
            ...
            if (mappings.RootObjectProvider != null)
            {
                ...
                var getRootObject = builder.DefineMethod(so, new IXamlXType[0],
            ...
            if (mappings.ParentStackProvider != null)
            {
                ...
                var objectEnumerable = typeSystem
                    ...
                    .MakeGenericType(new[] {typeSystem.GetType("System.Object")});
                var getParents = builder.DefineMethod(objectEnumerable, new IXamlXType[0],
            ...
            XamlXLanguageTypeMappings mappings)
        {
            ...
            void PropertyStub(string name)
            {
                ...
                var getContainer = builder.DefineMethod(originalGetter.ReturnType, new IXamlXType[0],
