...
{
    public class XamlXNamespaceInfoHelper
    {
        
        public class NamespaceResolveResult
        {
            public string ClrNamespace { get; set; }
            public IXamlXAssembly Assembly { get; set; }
            public string AssemblyName { get; set; }
        }
        
        public static List<NamespaceResolveResult> TryResolve(XamlXTransformerConfiguration config, string xmlns)
        {
        ...
        public static IXamlXField EmitNamespaceInfoProvider(XamlXTransformerConfiguration configuration,
            IXamlXTypeBuilder typeBuilder, XamlXDocument document)
        {
            ...
            {
                ctor.Generator
                    .Newobj(listType.FindConstructor(new List<IXamlXType>()))
                    .Stloc(listLocal);
