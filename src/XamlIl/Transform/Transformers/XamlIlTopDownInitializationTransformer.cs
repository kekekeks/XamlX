...
namespace XamlIl.Transform.Transformers
{
    ...
    public
#endif
    class XamlIlTopDownInitializationTransformer : IXamlIlAstTransformer
    {
        public IXamlIlAstNode Transform(XamlIlAstTransformationContext context, IXamlIlAstNode node)
        {
                ...
                IXamlIlAstValueNode checkedNode, out IXamlIlAstValueNode value, out IXamlIlAstManipulationNode deferred)
            {
                ...
                var local = new XamlIlAstCompilerLocalNode(manipulation.Value, manipulation.Value.Type.GetClrTypeReference());
                value = new XamlIlValueNodeWithBeginInit(new XamlIlAstLocalInitializationNodeEmitter(local, manipulation.Value, local));
