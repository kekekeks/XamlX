...
using XamlParserContext = XamlIl.Parsers.SystemXamlMarkupExtensionParser.MeScannerContext;
using XamlType = XamlIl.Parsers.SystemXamlMarkupExtensionParser.MeScannerTypeName;
using XamlMember = XamlIl.Ast.XamlIlAstNamePropertyReference;
using XamlTypeName = XamlIl.Parsers.SystemXamlMarkupExtensionParser.MeScannerTypeName;
using SR = XamlIl.Parsers.SystemXamlMarkupExtensionParser.MeScannerSr;
using SRID = XamlIl.Parsers.SystemXamlMarkupExtensionParser.MeScannerSRID;
using XamlParseException = XamlIl.Parsers.SystemXamlMarkupExtensionParser.MeScannerParseException;
using SpecialBracketCharacters = XamlIl.Parsers.SystemXamlMarkupExtensionParser.MeScannerSpecialBracketCharacters;
using KnownStrings = XamlIl.Parsers.SystemXamlMarkupExtensionParser.MeScannerKnownStrings;
...
/*
        ...
        {
            return null;
            // XamlIl resolves markup extension types after parsing the initial AST,
