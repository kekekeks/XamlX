...
// Yet another Cecil member that was never exposed nor used outside of WinMD code
// https://github.com/jbevain/cecil/blob/56d4409b8a0165830565c6e3f96f41bead2c418b/Mono.Cecil/GenericParameterResolver.cs#L5
...
internal sealed class GenericParameterResolver
{
	...
	{
		return ResolveIfNeeded(null, propertyReference.DeclaringType as GenericInstanceType, propertyReference.PropertyType);
	}
	...
	{
		var declaringGenericInstanceType = property.DeclaringType as GenericInstanceType;

		if (declaringGenericInstanceType == null)
			return parameter.ParameterType;

		return ResolveIfNeeded(null, declaringGenericInstanceType, parameter.ParameterType);
	}
